...
function About(){
    return(
        <Container>
            ...
            <div className="Right">
            <Paragraph color="GreyTitle" size="ParagraphPrincipal">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ratione et accusantium praesentium iure enim, voluptatem itaque officiis nobis rem quis, in nesciunt ex temporibus assumenda quod non ipsa debitis.
            </Paragraph>
            </div>
            </ContainerHeader>  
        </Container>
